jQuery(window).load(function(e) {
	jQuery('#links-list').clone().appendTo('#mob-links');
	jQuery('#cat-list').clone().appendTo('#mob-cats');
});
...
jQuery(document).ready(function(e) {
	...
	jQuery('#homeCarousel').appendTo('#full-width-slider-inner');
	jQuery('#full-width-slider-inner').removeAttr('style');
	jQuery('#full-width-slider').removeAttr('style');
});
